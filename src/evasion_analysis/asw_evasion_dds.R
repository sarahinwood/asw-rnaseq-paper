...
##"Y:/sarahinwood/asw_projects/asw-mh-combined-transcriptome/output/asw_edited_transcript_ids/Trinity.fasta.gene_trans_map" on pc
...
##save dds object
saveRDS(dds, "output/evasion_deseq2/asw_evasion_dds.rds")

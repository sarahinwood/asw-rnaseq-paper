...
asw_gene2tx <- fread(asw_gene_trans_map, header = FALSE)
...
txi <- tximport(all_quant_files, type = "salmon", tx2gene = asw_tx2gene, dropInfReps=TRUE)
...
##save dds object
saveRDS(dds, "output/deseq2/asw_all_dds.rds")

...
asw_dds <- readRDS("output/exposure_deseq2/asw_exposure_dds.rds")
...
fwrite(ordered_res_group_table, "output/exposure_deseq2/res_group.csv")
...
fwrite(ordered_sig_res_group_table, "output/exposure_deseq2/sig_degs.csv")
...
fwrite(sig_annots, "output/exposure_deseq2/sig_annots.csv")
